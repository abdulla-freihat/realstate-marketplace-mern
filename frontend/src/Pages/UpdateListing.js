...
const UpdateListing = () => {
          ...
          const params =  useParams();
             ...
             useEffect(()=>{
               ...
               const fetchListings = async ()=>{
                 ...
                 const res =    await fetch(`http://localhost:8000/listing/get/${listingId}`);
      ...
      const handleImageSubmit= ()=>{
       ...
       const submitHandler = async(e)=>{
           ...
           setError(false);
            ...
            const res = await fetch(`http://localhost:8000/listing/update/${params.id}`, {
   ...
   return (
     <main className='p-3 max-w-4xl mx-auto'>
         <h1 className='text-2xl text-center my-7 font-bold'>Update a Listing</h1>
              ...
              <input type="text"  placeholder='Address'  className='border p-3 outline-none rounded-lg' id='address'  required  onChange={handleChange} value={formData.address} />
                ...
                <div className='flex flex-col gap-4 flex-1'>
                    <p className='font-semibold text-sm'>Images : <span className='text-gray-600'>The first image will be cover (max 6)</span></p>
                      ...
                      <button type='submit'  className=' bg-slate-700 hover:bg-slate-800 uppercase text-white  p-3 rounded-lg'>Update Listing</button>
